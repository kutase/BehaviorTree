...
namespace Plugins.BehaviorTree.Runtime.Configs
{
    ...
    public class BehaviorTreeConfig : ScriptableObject
    {
        ...
        [Header("Node Textures")] public Texture2D nodeBackgroundTexture;
        public Texture2D nodeGradient;
        public Texture2D portTexture;

        [Header("Node Colors")] public Color compositeColor;
        public Color decoratorColor;
        public Color conditionalColor;
        public Color serviceColor;
        public Color taskColor;

        [Header("Status Colors")] public Color defaultNodeBackgroundColor;
        ...
        [Header("Runtime Colors")] public Color runningStatusColor = new Color(0.1f, 1f, 0.54f, 1f);
